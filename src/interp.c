...
/* Vamp ^^^^ */
    ...
    { "newbiepack",	do_newbiepack,	POS_STANDING,	0, LOG_NORMAL,0,0,0},
...
/* Tag commands */
    ...
    { "invis",		do_invis,	POS_DEAD,	 	 0,  LOG_NORMAL, 0,0,0	},
    ...
    { "wb",		do_watchbot,	POS_DEAD,	 	 0,  LOG_NORMAL, 0,0,0	},
    { "botwar",		do_botwar,	POS_DEAD,		  0, LOG_NORMAL, 0,0,0	},
    { "botpeace",	do_botpeace,	POS_DEAD,		  0, LOG_NORMAL, 0,0,0	},
    { "botnormal",	do_botnormal,	POS_DEAD,		  0, LOG_NORMAL, 0,0,0	},
    { "setoverseer",	do_setoverseer,	POS_DEAD,		  8, LOG_ALWAYS, 0,0,0	},
